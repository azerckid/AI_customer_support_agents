from agents import Agent, RunContextWrapper, Runner, input_guardrail, GuardrailFunctionOutput
...
input_guardrail_agent = Agent(
    ...
    instructions="""
You are an input guardrail agent. Your job is to determine if a user's request is off-topic.
